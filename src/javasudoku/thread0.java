...
public class thread0 implements Runnable {
    ...
    private static boolean sudokuCoz (int[][] sudoku, int satir, int sutun) {
        ...
        if(JavaSudoku.kontrol1==0 && JavaSudoku.kontrol2==0) {
            if(sutun == sudoku[0].length){
                satir++;
                if(satir == sudoku.length){
                    if(JavaSudoku.kontrol0==0 &&JavaSudoku.kontrol1==0 &&JavaSudoku.kontrol2==0){ 
                        JavaSudoku.kontrol0=1;
                        System.out.println("_______________________________ \nthread0  çözüme ulaştı ");
            ...
            if (sudoku[satir][sutun] > 0) {
                ...
                for (int i : getUygunSayilar(sudoku, satir, sutun)) {
                    ...
                    texteMatrisYaz("C:\\Users\\User\\Desktop\\Yazılım Lab\\Ornekler\\SudokuCoz0Adimlari.txt",sudoku);
